...
void ProgressBar::draw() {
    ...
    // border color
    bar->fillRect(0, 0, width, height, bcolor.r, bcolor.g, bcolor.b, 255); 

    // color
    bar->fillRect(bwidth, bwidth, pos, (height - (bwidth * 2)), color.r, color.g, color.b, 255); 

    bar->drawOn(screen, x, y);
    update();
