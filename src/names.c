...
const char *getReagentName(Reagent reagent) {   
	...
	if (reagent < REAG_MAX) { return reagentNames[reagent - REAG_ASH]; }
	else { return "???"; }
}
...
const char *getVirtueName(Virtue virtue) {
	...
	if (virtue < 8) { return virtueNames[virtue - VIRT_HONESTY]; }
	else { return "???"; }
}
...
const char *getVirtueAdjective(Virtue virtue) {
	...
	if (virtue < 8) { return virtueAdjectives[virtue - VIRT_HONESTY]; }
	else { return "???"; }
}
...
const char *getItemName(Item item) {
	switch (item) {
		...
		case ITEM_CANDLE: return "Candle";
		case ITEM_BOOK: return "Book";
		case ITEM_BELL: return "Bell";
		case ITEM_KEY_C: return "Courage";
		case ITEM_KEY_L: return "Love";
		case ITEM_KEY_T: return "Truth";
		case ITEM_HORN: return "Horn";
		case ITEM_WHEEL: return "Wheel";
		default: return "???";
	}
}
