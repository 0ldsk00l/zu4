...
public:
    ...
    static void flashTile(const MapCoords &coords, MapTile tile, int timeFactor);
    static void flashTile(const MapCoords &coords, const std::string &tilename, int timeFactor);
